...
> These are Some valuable resources for learning Machine learning.
  ...
  <table width="100%">
      ...
      <tr>
       ...
       <tr>
         <td><a href="https://techdevguide.withgoogle.com/paths/machine-learning/?no-filter=true">Machine Learning by Google Tech Dev Guide</a></td>
         <td>Explore ML techniques and innovative ML approaches like deep learning and neural networks as well. Course provided by Google for absolutely Free.</td>
    </tr>
 <tr>
 <td><a href="https://www.kaggle.com/learn/intro-to-deep-learning">Deep Learning by Kaggle</a></td>
 <td>Introduction to Deep Learning by Kaggle. Using TensorFlow and Keras to build and train neural networks for structured data.</td>
 </tr>
