...
#### Roadmap.sh
> [Roadmap.sh] <a href="https://roadmap.sh/">
  <img src="https://cdn-1.webcatalog.io/catalog/roadmap-sh/roadmap-sh-icon-filled-256.webp?v=1714780925346" alt="Roadmap.sh Logo" width="50" /></a> (https://roadmap.sh/) contains community-curated roadmaps, study plans, paths, and resources for developers. 
